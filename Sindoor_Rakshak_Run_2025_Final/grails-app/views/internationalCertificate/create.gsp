...
<html>
 ...
 <img src="../images/header2.png" class="img-fluid" alt="Responsive Image" style="border-radius:3px;width:100%;"  />
</div>

  <div class="text-center">
    <h1 class="display-5 fw-bold " style="color:#00008B;margin-top: 50px;">Sindoor Rakshak Run Unite To Protect</h1>
  </div>
  
   <div class="text-center m-3">
    <p style="color:black;font-size:18px;margin-top: 50px;">Congratulations for successfully participating in <span style="font-weight:bold;">#Sindoor Rakshak Run Bidar 2025</span> organized by <span style="font-weight:bold;">Global Sainik Academy in Association With The Rotary Clubs Bidar</span><span style="font-weight:bold;"></span></p>
  </div>
  ...
  <div class="container card shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="border:2px solid blue;margin-top:50px;border-radius: 10px;">
    <h4 style="display: flex;align-items: center;justify-content: center;color: #00008B;text-transform: uppercase;">Fill the below details to download the certificate</h4><br/>
...
--%><g:hasErrors bean="${certificateInstance}">
			...
			<g:form url="[resource:internationalCertificateInstance, action:'save']" >
				...
				<fieldset class="buttons">
					<g:submitButton  name="create" class="save" value="${message(code: 'default.button.Generate Certificate.label', default: 'Generate Certificate')}"button type="submit" class="btn btn-dark" style="background-color: #00008B;font-size: large;font-weight:bold;display: flex;margin: auto;" />
				</fieldset>
