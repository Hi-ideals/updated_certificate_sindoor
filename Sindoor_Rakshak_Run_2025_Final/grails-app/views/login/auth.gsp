...
<style>
  ...
  color: white;
  background: linear-gradient(270deg, #1D2B64, #FF512F, #F09819);
  background-size: 600% 600%;
  animation: gradientShift 3s ease infinite, pulseBorder 1s infinite alternate;
  padding: 10px 25px;
  border-radius: 10px;
  cursor: pointer;
  text-align: center;
...
/* Optional border pulse animation */
...
<body class=" login">
	 ...
	 <div>
	    ...
	    <img src="../images/bannerf.png" class="img-fluid" alt="Responsive Image" style="width:100%;height:600px;">   
	  
	   		 
	   		<g:link controller="InternationalCertificate" action="create"> 
	   		<button class="btn btn-primary btn-center blinking-btn" style="background-color: #00008B;font-size: 25px;font-weight:bold;border:4px solid white;">Download Certificate</button></g:link>
